...
import com.Lbins.TvApp.library.internal.EmptyViewMethodAccessor;
import com.Lbins.TvApp.library.internal.IndicatorLayout;

public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends com.Lbins.TvApp.library.PullToRefreshBase<T> implements
        OnScrollListener {
     ...
     * {@link com.Lbins.TvApp.library.PullToRefreshBase.Mode#PULL_FROM_START}. The default value is <var>true</var> if
     * {@link com.Lbins.TvApp.library.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    /**
     * Pass-through method for {@link com.Lbins.TvApp.library.PullToRefreshBase#getRefreshableView()
     * getRefreshableView()}.
     ...
     * a state where a Pull-to-Refresh can happen. An example of this state is
     * when the Adapter View is scrolled to the top and the mode is set to
     * {@link com.Lbins.TvApp.library.PullToRefreshBase.Mode#PULL_FROM_START}
     *
