 ...
 * *****************************************************************************
 */
package com.Lbins.TvApp.library;
...
import com.Lbins.TvApp.library.*;
import com.Lbins.TvApp.library.ILoadingLayout;
import com.Lbins.TvApp.library.IPullToRefresh;
import com.Lbins.TvApp.library.LoadingLayoutProxy;
import com.Lbins.TvApp.library.OverscrollHelper;
import com.Lbins.TvApp.library.internal.*;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public static enum Mode {
         ...
         * {@link com.Lbins.TvApp.library.PullToRefreshBase#setRefreshing() setRefreshing()}.
         */
     ...
     * {@link com.Lbins.TvApp.library.PullToRefreshAdapterViewBase#setOnLastItemVisibleListener}.
     *
     * @author Chris Banes
     */
     ...
     * (such as sounds). See (
     * {@link com.Lbins.TvApp.library.PullToRefreshAdapterViewBase#setOnPullEventListener}.
     *
     * @author Chris Banes
     */
    public static interface OnPullEventListener<V extends View> {
         ...
         */
        public void onPullEvent(final com.Lbins.TvApp.library.PullToRefreshBase<V> refreshView, State state, Mode direction);
    ...
    public static interface OnRefreshListener<V extends View> {
         ...
         * end
         */
        public void onRefresh(final com.Lbins.TvApp.library.PullToRefreshBase<V> refreshView);
    ...
    public static interface OnRefreshListener2<V extends View> {
         ...
         */
        public void onPullDownToRefresh(final com.Lbins.TvApp.library.PullToRefreshBase<V> refreshView);

        /**
         * onPullUpToRefresh will be called only when the user has Pulled from
         * the end, and released.
         */
        public void onPullUpToRefresh(final com.Lbins.TvApp.library.PullToRefreshBase<V> refreshView);
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                ViewCompat.postOnAnimation(com.Lbins.TvApp.library.PullToRefreshBase.this, this);
            } else {
                if (null != mListener) {
