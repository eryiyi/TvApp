...
import com.Lbins.TvApp.huanxin.db.DbOpenHelper;
import com.Lbins.TvApp.huanxin.db.UserDao;
import com.Lbins.TvApp.huanxin.domain.InviteMessage;
import com.Lbins.TvApp.huanxin.domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    static private com.Lbins.TvApp.huanxin.db.DemoDBManager dbMgr = new com.Lbins.TvApp.huanxin.db.DemoDBManager();
    private com.Lbins.TvApp.huanxin.db.DbOpenHelper dbHelper;

    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(TvApplication.getInstance().getApplicationContext());
    }

    public static synchronized com.Lbins.TvApp.huanxin.db.DemoDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new com.Lbins.TvApp.huanxin.db.DemoDBManager();
        }
        return dbMgr;
    }
