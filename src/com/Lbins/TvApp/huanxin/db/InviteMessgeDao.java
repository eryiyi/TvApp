...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return com.Lbins.TvApp.huanxin.db.DemoDBManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
	    com.Lbins.TvApp.huanxin.db.DemoDBManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return com.Lbins.TvApp.huanxin.db.DemoDBManager.getInstance().getMessagesList();
	}

	public void deleteMessage(String from){
	    com.Lbins.TvApp.huanxin.db.DemoDBManager.getInstance().deleteMessage(from);
	}

	public int getUnreadMessagesCount(){
	    return com.Lbins.TvApp.huanxin.db.DemoDBManager.getInstance().getUnreadNotifyCount();
	}
