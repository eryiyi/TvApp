 ...
 */
package com.Lbins.TvApp.huanxin.runtimepermissions;
...
import com.Lbins.TvApp.huanxin.runtimepermissions.*;
...
public class PermissionsManager {
  ...
  private static final String TAG = com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsManager.class.getSimpleName();

  private final Set<String> mPendingRequests = new HashSet<String>(1);
  private final Set<String> mPermissions = new HashSet<String>(1);
  private final List<WeakReference<com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction>> mPendingActions = new ArrayList<WeakReference<com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction>>(1);

  private static com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsManager mInstance = null;

  public static com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsManager getInstance() {
    if (mInstance == null) {
      mInstance = new com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsManager();
    }
    return mInstance;
  }
  ...
  /**
   * This method adds the {@link com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction} to the current list
  ...
  private synchronized void addPendingAction(@NonNull String[] permissions,
      @Nullable com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction action) {
    if (action == null) {
      return;
    }
    action.registerPermissions(permissions);
    mPendingActions.add(new WeakReference<com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction>(action));
  }
   ...
   */
  private synchronized void removePendingAction(@Nullable com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction action) {
    for (Iterator<WeakReference<com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction>> iterator = mPendingActions.iterator();
        iterator.hasNext(); ) {
      WeakReference<com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction> weakRef = iterator.next();
   ...
   * for the specified {@link com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction}. The purpose of this method is to enable
  ...
  public synchronized void requestAllManifestPermissionsIfNecessary(final @Nullable Activity activity,
      final @Nullable com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction action) {
    if (activity == null) {
      return;
    }
  ...
  /**
   * This method should be used to execute a {@link com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction} for the array
   ...
   * @param permissions the list of permissions to request for the {@link com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction}.
...
//        fragment.requestPermissions(permsToRequest, 1);
  ...
  public synchronized void notifyPermissionsChange(@NonNull String[] permissions, @NonNull int[] results) {
    ...
    Iterator<WeakReference<com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction>> iterator = mPendingActions.iterator();
    while (iterator.hasNext()) {
      com.Lbins.TvApp.huanxin.runtimepermissions.PermissionsResultAction action = iterator.next().get();
