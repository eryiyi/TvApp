...
import com.Lbins.TvApp.huanxin.video.util.RecyclingBitmapDrawable;
import com.Lbins.TvApp.huanxin.video.util.Utils;
 ...
 * {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCache.ImageCacheParams)}
...
public class ImageCache {
	...
	/**
	 * Return an {@link ImageCache} instance. A {@link ImageCache.RetainFragment} is used
	...
	private void init(ImageCacheParams cacheParams) {
		...
		if (mCacheParams.memoryCacheEnabled) {
			...
			// bitmaps).
			if (com.Lbins.TvApp.huanxin.video.util.Utils.hasHoneycomb()) {
			...
			mMemoryCache = new LruCache<String, BitmapDrawable>(
				...
				protected void entryRemoved(boolean evicted, String key,
					...
					if (com.Lbins.TvApp.huanxin.video.util.RecyclingBitmapDrawable.class.isInstance(oldValue)) {
						// The removed entry is a recycling drawable, so notify
						// it
						// that it has been removed from the memory cache
						((com.Lbins.TvApp.huanxin.video.util.RecyclingBitmapDrawable) oldValue).setIsCached(false);
					} else {
	...
	public void addBitmapToCache(String data, BitmapDrawable value) {
		...
		if (mMemoryCache != null) {
			if (com.Lbins.TvApp.huanxin.video.util.RecyclingBitmapDrawable.class.isInstance(value)) {
				// The removed entry is a recycling drawable, so notify it
				// that it has been added into the memory cache
				((com.Lbins.TvApp.huanxin.video.util.RecyclingBitmapDrawable) value).setIsCached(true);
			}
	...
	private static boolean canUseForInBitmap(Bitmap candidate,
		...
		if (!com.Lbins.TvApp.huanxin.video.util.Utils.hasKitKat()) {
...
//		}
		...
		if (com.Lbins.TvApp.huanxin.video.util.Utils.hasHoneycombMR1()) {
	...
	public static boolean isExternalStorageRemovable() {
		if (com.Lbins.TvApp.huanxin.video.util.Utils.hasGingerbread()) {
	...
	public static File getExternalCacheDir(Context context) {
		if (com.Lbins.TvApp.huanxin.video.util.Utils.hasFroyo()) {
