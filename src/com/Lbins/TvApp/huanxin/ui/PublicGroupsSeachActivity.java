...
public class PublicGroupsSeachActivity extends com.Lbins.TvApp.base.BaseActivity {
    ...
    public void enterToDetails(View view){
        startActivity(new Intent(this, com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity.class));
    }
}
