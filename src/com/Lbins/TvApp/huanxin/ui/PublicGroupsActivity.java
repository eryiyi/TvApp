...
import com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity;
...
public class PublicGroupsActivity extends com.Lbins.TvApp.base.BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(PublicGroupsActivity.this, com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity.class).
	...
	public void search(View view){
	    startActivity(new Intent(this, com.Lbins.TvApp.huanxin.ui.PublicGroupsSeachActivity.class));
	}
