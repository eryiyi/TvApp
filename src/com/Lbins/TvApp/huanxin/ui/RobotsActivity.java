...
public class RobotsActivity extends BaseActivity {
	...
	public static final String TAG = com.Lbins.TvApp.huanxin.ui.RobotsActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle arg0) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				intent.setClass(com.Lbins.TvApp.huanxin.ui.RobotsActivity.this, ChatActivity.class);
			...
			public void onSuccess(final List<EMContact> value) {
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						// save it in database
						UserDao dao = new UserDao(com.Lbins.TvApp.huanxin.ui.RobotsActivity.this);
