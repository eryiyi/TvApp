    ...
    protected Handler handler = new Handler(callHandlerThread.getLooper()) {
        ...
        public void handleMessage(Message msg) {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toast.makeText(com.Lbins.TvApp.huanxin.ui.CallActivity.this, st2, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                break;
            case MSG_CALL_ANSWER:
                ...
                if (isInComingCall) {
                    try {
                        if (NetUtils.hasDataConnection(com.Lbins.TvApp.huanxin.ui.CallActivity.this)) {
