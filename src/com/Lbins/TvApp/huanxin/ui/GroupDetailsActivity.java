...
import com.Lbins.TvApp.huanxin.ui.EditActivity;
import com.Lbins.TvApp.huanxin.ui.GroupBlacklistActivity;
import com.Lbins.TvApp.huanxin.ui.GroupSearchMessageActivity;
import com.Lbins.TvApp.module.Emp;
import com.Lbins.TvApp.ui.GroupAddEmpActivity;
...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public static com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity instance;
...
//		idLayout.setVisibility(View.VISIBLE);
					...
					public void onResponse(String s) {
						if (StringUtil.isJson(s)) {
							...
							if (Integer.parseInt(data.getCode()) == 200) {
								...
								Toast.makeText(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, "获得数据失败，请稍后重试", Toast.LENGTH_SHORT).show();
							}
						} else {
							Toast.makeText(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, "获得数据失败，请稍后重试", Toast.LENGTH_SHORT).show();
						}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			if (progressDialog == null) {
				progressDialog = new ProgressDialog(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this);
	...
	public void onClick(View v) {
		...
		case R.id.clear_all_history: // 清空聊天记录
			...
			new EaseAlertDialog(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, null, st9, null, new AlertDialogUser() {
		...
		case R.id.rl_blacklist: // 黑名单列表
			startActivity(new Intent(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, GroupBlacklistActivity.class).putExtra("groupId", groupId));
			break;
...
//									REQUEST_CODE_ADD_USER);
							startActivityForResult(
									(new Intent(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, GroupAddEmpActivity.class).putExtra("groupId", groupId)),
									REQUEST_CODE_ADD_USER);
						}
					});
//				}
...
//				Emp emp= DBHelper.getInstance(GroupDetailsActivity.this).getEmpById(username);
					if(emp != null){
						...
						imageLoader.displayImage(emp.getMm_emp_cover(), holder.imageView, TvApplication.txOptions, animateFirstListener);
					}else{
...
//					EaseUserUtils.setUserAvatar(getContext(), username, holder.imageView);
					...
					button.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							if (isInDeleteMode) {
								...
								if (EMClient.getInstance().getCurrentUser().equals(emp.getHxusername())) {
									new EaseAlertDialog(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, st12).show();
									return;
								}
						...
						protected void deleteMembersFromGroup(final String username) {
							final ProgressDialog deleteDialog = new ProgressDialog(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this);
					...
					button.setOnLongClickListener(new OnLongClickListener() {
						...
						public boolean onLongClick(View v) {
							if(EMClient.getInstance().getCurrentUser().equals(emp.getHxusername()))
								return true;
							if (group.getOwner().equals(EMClient.getInstance().getCurrentUser())) {
								new EaseAlertDialog(com.Lbins.TvApp.huanxin.ui.GroupDetailsActivity.this, null, st15, null, new AlertDialogUser() {
