...
import com.Lbins.TvApp.huanxin.ui.PickContactNoCheckboxActivity;
		...
		new EaseAlertDialog(this, null, getString(R.string.confirm_forward_to, selectUser.getNick()), null, new AlertDialogUser() {
            ...
            public void onResult(boolean confirmed, Bundle bundle) {
                if (confirmed) {
                    ...
                    Intent intent = new Intent(com.Lbins.TvApp.huanxin.ui.ForwardMessageActivity.this, ChatActivity.class);
                    // it is single chat
