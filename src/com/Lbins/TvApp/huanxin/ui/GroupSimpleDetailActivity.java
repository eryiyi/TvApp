...
import com.Lbins.TvApp.huanxin.ui.PublicGroupsSeachActivity;
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							Toast.makeText(com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity.this, st1+e.getMessage(), 1).show();
						}
					});
				}
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
							if(group.isMembersOnly())
								Toast.makeText(com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity.this, st3, 0).show();
							else
								Toast.makeText(com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity.this, st4, 0).show();
					...
					runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
							Toast.makeText(com.Lbins.TvApp.huanxin.ui.GroupSimpleDetailActivity.this, st5+e.getMessage(), 0).show();
						}
					});
				}
			}
