	...
	protected void onCreate(Bundle arg0) {
		...
		saveNickName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dialog = ProgressDialog.show(com.Lbins.TvApp.huanxin.ui.OfflinePushNickActivity.this, "update nickname...", "waiting...");
					...
					public void run() {
						...
						if (!updatenick) {
							runOnUiThread(new Runnable() {
								public void run() {
									Toast.makeText(com.Lbins.TvApp.huanxin.ui.OfflinePushNickActivity.this, "update nickname failed!",
							...
							runOnUiThread(new Runnable() {
								public void run() {
									...
									if (!updatenick) {
										...
										dialog.dismiss();
										Toast.makeText(com.Lbins.TvApp.huanxin.ui.OfflinePushNickActivity.this, "update nickname success!",
												Toast.LENGTH_SHORT).show();
									}
								}
							});
