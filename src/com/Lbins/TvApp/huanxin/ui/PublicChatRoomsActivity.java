	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(com.Lbins.TvApp.huanxin.ui.PublicChatRoomsActivity.this, ChatActivity.class).putExtra("chatType", 3).
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(isFirstLoading){
                                ...
                                adapter = new ChatRoomAdapter(com.Lbins.TvApp.huanxin.ui.PublicChatRoomsActivity.this, 1, chatRoomList);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            pb.setVisibility(View.INVISIBLE);
                            footLoadingLayout.setVisibility(View.GONE);
                            Toast.makeText(com.Lbins.TvApp.huanxin.ui.PublicChatRoomsActivity.this, getResources().getString(R.string.failed_to_load_data), 0).show();
                        }
                    });
                }
            }
