		...
		new Thread(new Runnable() {
			public void run() {
				if (DemoHelper.getInstance().isLoggedIn()) {
					...
					//enter main screen
					startActivity(new Intent(com.Lbins.TvApp.huanxin.ui.SplashActivity.this, MainActivity.class));
					finish();
				}else {
					try {
					...
					startActivity(new Intent(com.Lbins.TvApp.huanxin.ui.SplashActivity.this, LoginActivity.class));
					finish();
				}
			}
		}).start();
