...
import com.Lbins.TvApp.huanxin.ui.ExitGroupDialog;
...
public class ChatRoomDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public static com.Lbins.TvApp.huanxin.ui.ChatRoomDetailsActivity instance;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			if (progressDialog == null) {
				progressDialog = new ProgressDialog(com.Lbins.TvApp.huanxin.ui.ChatRoomDetailsActivity.this);
	...
	public void onClick(View v) {
		...
		case R.id.clear_all_history: // clear conversation history
			...
			new EaseAlertDialog(com.Lbins.TvApp.huanxin.ui.ChatRoomDetailsActivity.this, null, st9, null, new AlertDialogUser() {
