...
//			startActivityForResult(new Intent(this, GroupPickContactsActivity.class).putExtra("groupName", name), 0);
	...
	void addGroup(){
		...
		try {
			...
			String reason = com.Lbins.TvApp.huanxin.ui.NewGroupActivity.this.getString(R.string.invite_join_group);
				...
				public void run() {
					...
					try {
						...
						runOnUiThread(new Runnable() {
							public void run() {
								progressDialog.dismiss();
								Toast.makeText(com.Lbins.TvApp.huanxin.ui.NewGroupActivity.this, st2 + e.getLocalizedMessage(), 1).show();
							}
						});
					}
