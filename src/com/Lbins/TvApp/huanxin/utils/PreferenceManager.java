 ...
 */
package com.Lbins.TvApp.huanxin.utils;
...
public class PreferenceManager {
	...
	private static com.Lbins.TvApp.huanxin.utils.PreferenceManager mPreferencemManager;
	...
	public static synchronized void init(Context cxt){
	    if(mPreferencemManager == null){
	        mPreferencemManager = new com.Lbins.TvApp.huanxin.utils.PreferenceManager(cxt);
	    }
	}
	 ...
	 * @return
	 */
	public synchronized static com.Lbins.TvApp.huanxin.utils.PreferenceManager getInstance() {
		if (mPreferencemManager == null) {
