package com.Lbins.TvApp.huanxin.parse;

import android.content.Context;
import com.Lbins.TvApp.huanxin.DemoHelper;
import com.Lbins.TvApp.huanxin.parse.*;
import com.Lbins.TvApp.huanxin.parse.ParseManager;
...
public class UserProfileManager {
	...
	public synchronized boolean init(Context context) {
		...
		com.Lbins.TvApp.huanxin.parse.ParseManager.getInstance().onInit(context);
	...
	public void asyncFetchContactInfosFromServer(List<String> usernames, final EMValueCallBack<List<EaseUser>> callback) {
		...
		com.Lbins.TvApp.huanxin.parse.ParseManager.getInstance().getContactInfos(usernames, new EMValueCallBack<List<EaseUser>>() {
	...
	public boolean updateCurrentUserNickName(final String nickname) {
		boolean isSuccess = com.Lbins.TvApp.huanxin.parse.ParseManager.getInstance().updateParseNickName(nickname);
		if (isSuccess) {
	...
	public String uploadUserAvatar(byte[] data) {
		String avatarUrl = com.Lbins.TvApp.huanxin.parse.ParseManager.getInstance().uploadParseAvatar(data);
		if (avatarUrl != null) {
	...
	public void asyncGetCurrentUserInfo() {
		com.Lbins.TvApp.huanxin.parse.ParseManager.getInstance().asyncGetCurrentUserInfo(new EMValueCallBack<EaseUser>() {
