...
public class MyAlertDialog {
	...
	public com.Lbins.TvApp.widget.MyAlertDialog builder() {
		// 获取Dialog布局
	...
	public com.Lbins.TvApp.widget.MyAlertDialog setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
	...
	public com.Lbins.TvApp.widget.MyAlertDialog setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public com.Lbins.TvApp.widget.MyAlertDialog setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public com.Lbins.TvApp.widget.MyAlertDialog setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public com.Lbins.TvApp.widget.MyAlertDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public com.Lbins.TvApp.widget.MyAlertDialog setPositiveButton(String text,
	...
	public com.Lbins.TvApp.widget.MyAlertDialog setNegativeButton(String text,
										   final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");
