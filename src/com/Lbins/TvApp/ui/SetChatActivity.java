...
import com.Lbins.TvApp.huanxin.DemoModel;
import com.Lbins.TvApp.huanxin.ui.BlacklistActivity;
import com.Lbins.TvApp.huanxin.ui.DiagnoseActivity;
import com.Lbins.TvApp.huanxin.ui.OfflinePushNickActivity;
import com.Lbins.TvApp.huanxin.ui.UserProfileActivity;
...
//			RedPacketUtil.startChangeActivity(getActivity());
            ...
            case R.id.ll_black_list:
                startActivity(new Intent(com.Lbins.TvApp.ui.SetChatActivity.this, BlacklistActivity.class));
                break;
            case R.id.ll_diagnose:
                startActivity(new Intent(com.Lbins.TvApp.ui.SetChatActivity.this, DiagnoseActivity.class));
                break;
            case R.id.ll_set_push_nick:
                startActivity(new Intent(com.Lbins.TvApp.ui.SetChatActivity.this, OfflinePushNickActivity.class));
                break;
            case R.id.ll_user_profile:
                startActivity(new Intent(com.Lbins.TvApp.ui.SetChatActivity.this, UserProfileActivity.class).putExtra("setting", true)
    ...
    void logout() {
        final ProgressDialog pd = new ProgressDialog(com.Lbins.TvApp.ui.SetChatActivity.this);
            ...
            public void onSuccess() {
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        // show login screen
                        finish();
                        startActivity(new Intent(com.Lbins.TvApp.ui.SetChatActivity.this, com.Lbins.TvApp.huanxin.ui.LoginActivity.class));
            ...
            public void onError(int code, String message) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        pd.dismiss();
                        Toast.makeText(com.Lbins.TvApp.ui.SetChatActivity.this, "unbind devicetokens failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
