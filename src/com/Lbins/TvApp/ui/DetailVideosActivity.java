...
//    String shareUrl = InternetURL.SHARE_VIDEOS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //判断是否有网
        try {
            isMobileNet = GuirenHttpUtils.isMobileDataEnable(com.Lbins.TvApp.ui.DetailVideosActivity.this);
            isWifiNet = GuirenHttpUtils.isWifiDataEnable(com.Lbins.TvApp.ui.DetailVideosActivity.this);
            if (!isMobileNet && !isWifiNet) {
            }else {
                progressDialog =  new CustomProgressDialog(com.Lbins.TvApp.ui.DetailVideosActivity.this, "正在加载中", R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        detail_lstv.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                String label = DateUtils.formatDateTime(com.Lbins.TvApp.ui.DetailVideosActivity.this, System.currentTimeMillis(),
        ...
        detail_lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (commentContent != null) {
                    Intent comment = new Intent(com.Lbins.TvApp.ui.DetailVideosActivity.this, com.Lbins.TvApp.ui.PublishVideoCommentAcitvity.class);
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            isWifiNet = GuirenHttpUtils.isWifiDataEnable(com.Lbins.TvApp.ui.DetailVideosActivity.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(com.Lbins.TvApp.ui.DetailVideosActivity.this, "请检查网络链接");
                return;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        switch (v.getId()) {
            ...
            case R.id.detail_comment_liner://评论
                Intent comment = new Intent(com.Lbins.TvApp.ui.DetailVideosActivity.this, PublishVideoCommentAcitvity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode()) == 200) {
                                ...
                                Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                        }
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode()) == 200) {
                                ...
                                adaptertwo = new DetailFavourAdapter(itemList, com.Lbins.TvApp.ui.DetailVideosActivity.this , itemListtwo.size());
...
//                                            startActivity(favour);
        ...
        switch (flag) {
            case 1:
                if (!emp_id.equals(comt.getEmpId())) {
                    Intent mine = new Intent(com.Lbins.TvApp.ui.DetailVideosActivity.this, ProfileActivity.class);
                    mine.putExtra("mm_emp_id", comt.getEmpId());
                    startActivity(mine);
                } else {
                    Intent mine = new Intent(com.Lbins.TvApp.ui.DetailVideosActivity.this, EditEmpActivity.class);
                    startActivity(mine);
                }
                break;
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode() )== 200) {
                                //赞+1
                                Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, R.string.zan_success, Toast.LENGTH_SHORT).show();
                                //调用广播，刷新详细页评论
                            ...
                            if (Integer.parseInt(data.getCode() )== 1) {
                                Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, R.string.zan_error_one, Toast.LENGTH_SHORT).show();
                                detail_like_liner.setClickable(true);
                            }
                            if (Integer.parseInt(data.getCode()) == 2) {
                                Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, R.string.zan_error_two, Toast.LENGTH_SHORT).show();
                                detail_like_liner.setClickable(true);
                            }
                        } else {
                            Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, R.string.zan_error_two, Toast.LENGTH_SHORT).show();
    ...
    void share() {
        new ShareAction(com.Lbins.TvApp.ui.DetailVideosActivity.this).setDisplayList(SHARE_MEDIA.QQ, SHARE_MEDIA.QZONE, SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE)
    ...
    private ShareBoardlistener shareBoardlistener = new ShareBoardlistener() {
        ...
        public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
            UMImage image = new UMImage(com.Lbins.TvApp.ui.DetailVideosActivity.this, record.getPicUrl());
            ...
            new ShareAction(com.Lbins.TvApp.ui.DetailVideosActivity.this).setPlatform(share_media).setCallback(umShareListener)
                    .withText(content)
                    .withTitle(title)
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onResult(SHARE_MEDIA platform) {
            Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, platform + getResources().getString(R.string.share_success), Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onError(SHARE_MEDIA platform, Throwable t) {
            Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, platform + getResources().getString(R.string.share_error), Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onCancel(SHARE_MEDIA platform) {
            Toast.makeText(com.Lbins.TvApp.ui.DetailVideosActivity.this, platform + getResources().getString(R.string.share_cancel), Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        UMShareAPI.get(com.Lbins.TvApp.ui.DetailVideosActivity.this).onActivityResult(requestCode, resultCode, data);
    }
}
