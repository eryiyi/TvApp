...
public class TongxunluActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        try {
            isMobileNet = GuirenHttpUtils.isMobileDataEnable(com.Lbins.TvApp.ui.TongxunluActivity.this);
            isWifiNet = GuirenHttpUtils.isWifiDataEnable(com.Lbins.TvApp.ui.TongxunluActivity.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(com.Lbins.TvApp.ui.TongxunluActivity.this ,"请检查您网络链接");
            }else {
                progressDialog = new CustomProgressDialog(com.Lbins.TvApp.ui.TongxunluActivity.this, "正在加载中",R.anim.custom_dialog_frame);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode()) == 200) {
                                ...
                                showMsg(com.Lbins.TvApp.ui.TongxunluActivity.this, getResources().getString(R.string.get_data_error));
                            }
                        }else {
                            showMsg(com.Lbins.TvApp.ui.TongxunluActivity.this, getResources().getString(R.string.get_data_error));
                        }
    ...
    void initView(){
        ...
        adapter = new ContactAdapter(com.Lbins.TvApp.ui.TongxunluActivity.this, nicks);
        ...
        lvContact.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(com.Lbins.TvApp.ui.TongxunluActivity.this, ProfileActivity.class);
