        ...
        switch (view.getId()) {
            case R.id.btn_code:
                ...
                if (!TextUtils.isEmpty(mm_emp_mobile.getText().toString()) && mm_emp_mobile.getText().toString().length() == 11) {
                    ...
                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_seven));
                    return;
                }
                break;
            case R.id.btn:
                ...
                if (StringUtil.isNullOrEmpty(code.getText().toString())) {
                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_eight));
                    return;
                }

                if (StringUtil.isNullOrEmpty(password.getText().toString())) {
                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_three));
                    return;
                }
                if (password.getText().toString().length() > 18 || password.getText().toString().length() < 6) {
                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_four));
                    return;
                }
                if (StringUtil.isNullOrEmpty(surepass.getText().toString())) {
                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_five));
                    return;
                }
                if (!password.getText().toString().equals(surepass.getText().toString())) {
                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_six));
                    return;
                }
                progressDialog = new CustomProgressDialog(com.Lbins.TvApp.ui.ForgetActivity.this, "正在加载中",R.anim.custom_dialog_frame);
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code) == 200) {
                                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_success_one));
                                    save("password", password.getText().toString());
                                    finish();
                                } else {
                                    showMsg(com.Lbins.TvApp.ui.ForgetActivity.this, getResources().getString(R.string.pwr_error_nine));
                                }
...
//				((Throwable) data).printStackTrace();
                Toast.makeText(com.Lbins.TvApp.ui.ForgetActivity.this, R.string.code_msg_two, Toast.LENGTH_SHORT).show();
//					Toast.makeText(MainActivity.this, "123", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(des)) {
                        Toast.makeText(com.Lbins.TvApp.ui.ForgetActivity.this, des, Toast.LENGTH_SHORT).show();
                        return;
                    }
                } catch (Exception e) {
