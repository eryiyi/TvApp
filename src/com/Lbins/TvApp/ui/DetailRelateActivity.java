...
public class DetailRelateActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        //判断是否有网
        try {
            isMobileNet = GuirenHttpUtils.isMobileDataEnable(com.Lbins.TvApp.ui.DetailRelateActivity.this);
            isWifiNet = GuirenHttpUtils.isWifiDataEnable(com.Lbins.TvApp.ui.DetailRelateActivity.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(com.Lbins.TvApp.ui.DetailRelateActivity.this, "请检查网络链接");
                return;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        switch (v.getId()){
            ...
            case R.id.head:
            {
                Intent intent = new Intent(com.Lbins.TvApp.ui.DetailRelateActivity.this, ProfileActivity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (Integer.parseInt(data.getCode()) == 200) {
                                showMsg(com.Lbins.TvApp.ui.DetailRelateActivity.this, "操作成功！");
                                finish();
                            } else {
                                showMsg(com.Lbins.TvApp.ui.DetailRelateActivity.this, "操作失败");
                            }
                        } else {
                            showMsg(com.Lbins.TvApp.ui.DetailRelateActivity.this, "操作失败");
                        }
