...
import com.Lbins.TvApp.adapter.AlbumGridViewAdapter;
import com.Lbins.TvApp.ui.*;
import com.Lbins.TvApp.ui.AbsActivity;
import com.Lbins.TvApp.ui.AlbumChanceActivity;
    ...
    private void init() {
        ...
        cancelBT.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.Lbins.TvApp.ui.AlbumActivity.this.finish();
            }
        });
...
//				AlbumActivity.this.finish();
    ...
    private void initSelectImage() {
        ...
        for (final String path : selectedDataList) {
            ImageView imageView = (ImageView) LayoutInflater.from(com.Lbins.TvApp.ui.AlbumActivity.this).inflate(R.layout.choose_imageview, selectedImageLayout, false);
        ...
        gridImageAdapter.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final CheckBox toggleButton, int position, final String path, boolean isChecked) {
                if (selectedDataList.size() >= 9) {
                    ...
                    if (!removePath(path)) {
                        Toast.makeText(com.Lbins.TvApp.ui.AlbumActivity.this, "只能选择9张图片", Toast.LENGTH_SHORT).show();
                    }
                    return;
                }
                if (isChecked) {
