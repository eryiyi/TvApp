...
import com.Lbins.TvApp.wxapi.Constants;
...
//			builder.show();
			...
			if(resp.errCode == 0){
				//说明支付成功
				showMsg(com.Lbins.TvApp.wxapi.WXPayEntryActivity.this, "支付成功");
				//调用逻辑处理
				...
				//支付失败
				showMsg(com.Lbins.TvApp.wxapi.WXPayEntryActivity.this, "支付失败");
				ActivityTack.getInstanse().popUntilActivity(OrderMakeActivity.class);
			}
		}
