...
public class EaseMessageAdapter extends BaseAdapter{
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
		...
		if(emp != null){
//			imageLoader.displayImage(emp.getMm_emp_cover(), chatRow.userAvatarView, TvApplication.txOptions);
			imageLoader.displayImage(emp.getMm_emp_cover(), chatRow.userAvatarView, TvApplication.txOptions, animateFirstListener);
			if(chatRow.usernickView != null){
				chatRow.usernickView.setText(emp.getMm_emp_nickname()==null?"":emp.getMm_emp_nickname());
			}
		}else {
//			TvApplication.getInstance().getEmpId(message.getFrom());
		}
        return chatRow;
    }
...
//									imageLoader.displayImage(empInfo.getMm_emp_cover(), view , TvApplication.txOptions);
//								}
//
//							} else {
//
